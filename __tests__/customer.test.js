    ...
    const sampleLodgings = [
      {
        ...
        roomCapacity: 2,
        imgUrl:
          "https://images.adsttc.com/media/images/64b6/6d4f/cb9c/4614/f0a9/1a2f/slideshow/oberoi-villa-arkana-architects_8.jpg?1689677149",
        location: "Location 1",
        price: 75000,
        typeId: 1,
        status: "Active",
  ...
  describe("GET /customers/lodgings", () => {
    ...
    it("should return a list of lodgings with query filter parameter", async () => {
      const response = await request(app).get(
        "/customers/lodgings/?filterByTypeId=1"
      );
      expect(response.status).toBe(200);
      expect(response.body).toBeInstanceOf(Object);
    });
